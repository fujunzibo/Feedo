...
export type GetCompressedTokenAccountsByOwnerFn = (p: GetCompressedTokenAccountsByOwnerRequest) => Promise<GetCompressedTokenAccountsByOwnerResponse>;
...
export type GetCompressedTokenBalancesByOwnerFn = (p: GetCompressedTokenBalancesByOwnerRequest) => Promise<GetCompressedTokenBalancesByOwnerResponse>;
...
export type GetCompressedTokenBalancesByOwnerV2Fn = (p: GetCompressedTokenBalancesByOwnerRequest) => Promise<GetCompressedTokenBalancesByOwnerV2Response>;
...
export type GetCompressionSignaturesForAccountFn = (p: GetCompressionSignaturesForAccountRequest) => Promise<GetCompressionSignaturesForAccountResponse>;
...
export type GetCompressionSignaturesForAddressFn = (p: GetCompressionSignaturesForAddressRequest) => Promise<GetCompressionSignaturesForAddressResponse>;
...
export type GetCompressionSignaturesForOwnerFn = (p: GetCompressionSignaturesForOwnerRequest) => Promise<GetCompressionSignaturesForOwnerResponse>;
...
export type GetCompressionSignaturesForTokenOwnerFn = (p: GetCompressionSignaturesForTokenOwnerRequest) => Promise<GetCompressionSignaturesForTokenOwnerResponse>;
...
export type GetLatestCompressionSignaturesFn = (p?: GetLatestCompressionSignaturesRequest) => Promise<GetLatestCompressionSignaturesResponse>;
...
export type GetLatestNonVotingSignaturesFn = (p?: GetLatestNonVotingSignaturesRequest) => Promise<GetLatestNonVotingSignaturesResponse>;
...
export type GetMultipleCompressedAccountProofsFn = (hashes: GetMultipleCompressedAccountProofsRequest) => Promise<GetMultipleCompressedAccountProofsResponse>;
...
export type GetMultipleCompressedAccountsFn = (p: GetMultipleCompressedAccountsRequest) => Promise<GetMultipleCompressedAccountsResponse>;
...
export type GetValidityProofFn = (p: GetValidityProofRequest) => Promise<GetValidityProofResponse>;
export type AssetOp = "MintToCollectionV1" | "MintV1" | "Burn" | "Transfer" | "Sale" | string;
...
export type GetSignaturesForAssetFn = (p: GetSignaturesForAssetRequest) => Promise<GetSignaturesForAssetResponse>;
export type GetTransactionWithCompressionInfoFn = (p: GetTransactionWithCompressionInfoRequest) => Promise<GetTransactionWithCompressionInfoResponse>;
export type GetMultipleNewAddressProofsFn = (p: GetMultipleNewAddressProofsRequest) => Promise<GetMultipleNewAddressProofsResponse>;
export type GetMultipleNewAddressProofsV2Fn = (p: GetMultipleNewAddressProofsV2Request) => Promise<GetMultipleNewAddressProofsV2Response>;
...
export type GetCompressedAccountProofFn = (p: GetCompressedAccountProofRequest) => Promise<GetCompressedAccountProofResponse>;
export type GetCompressedAccountFn = (p: GetCompressedAccountRequest) => Promise<GetCompressedAccountResponse>;
