...
import { SENDER_TIP_ACCOUNTS } from './types.js';
...
const makeCreateSmartTransactionWithTip = (createSmartTransaction) => {
    const createWithTip = async (args) => {
        ...
        const tipIx = getTransferSolInstruction({
            ...
            amount: lamports(BigInt(args.tipAmount ?? 500000)),
        });
...
export { makeCreateSmartTransactionWithTip };
//# sourceMappingURL=createSmartTransactionWithTip.js.map
