...
`+o,i=u.join(F);l=`[
`+o+i+`,
`+n+"]"}return h.pop(),o=n,l}},J}var Fu=tu();const ru=R(Fu);function Cu(C,r){const s=eu(C,r?.reviver);return G(C,s,r),s}function Au(C,r){const s=W(C,r),c=ru(C,r?.replacer,s.indent);return s.whitespace.start+c+s.whitespace.end}export{Cu as parseJSON5,Au as stringifyJSON5};
